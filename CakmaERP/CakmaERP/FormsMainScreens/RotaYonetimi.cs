...
namespace CakmaERP.FormsMainScreens
{
    public partial class RotaYonetimi : Form
    {
        ...
        {
            DataTable dataTable = CRUD.Read("SELECT * FROM RotaYonetimi");
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            if (!string.IsNullOrEmpty(txtFirmaKodu.Text) && !string.IsNullOrEmpty(txtMalzemeTipi.Text))
            {
                ...
                CRUD.Update("RotaYonetimi", data, condition);
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            {
                string condition = $"firma_kodu = '{txtFirmaKodu.Text}'";
                CRUD.Delete("RotaYonetimi", condition);
