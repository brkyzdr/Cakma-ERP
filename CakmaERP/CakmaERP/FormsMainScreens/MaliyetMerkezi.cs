...
namespace CakmaERP.FormsMainScreens
{
    public partial class MaliyetMerkezi : Form
    {
        ...
        {
            DataTable dataTable = CRUD.Read("SELECT * FROM MaliyetMerkezi");
        ...
        private void btnCreate_Click(object sender, EventArgs e)
        {
            if (!string.IsNullOrEmpty(txtFirmaKodu.Text) && !string.IsNullOrEmpty(txtMaliyetMerkeziTipi.Text))
            {
                var data = new Dictionary<string, object>
                {
                    ...
                    { "malzeme_tipi", txtMaliyetMerkeziTipi.Text }
                };

                CRUD.Create("MaliyetMerkezi", data);
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            if (!string.IsNullOrEmpty(txtFirmaKodu.Text) && !string.IsNullOrEmpty(txtMaliyetMerkeziTipi.Text))
            {
                ...
                CRUD.Update("MaliyetMerkezi", data, condition);
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            {
                string condition = $"firma_kodu = '{txtFirmaKodu.Text}'";
                CRUD.Delete("MaliyetMerkezi", condition);
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                txtMaliyetMerkeziTipi.Text = row.Cells["malzeme_tipi"].Value.ToString();
            }
        }
    }
}
