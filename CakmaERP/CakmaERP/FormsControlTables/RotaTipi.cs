...
{
    public partial class RotaTipi : Form
    {
        public RotaTipi()
        {
            InitializeComponent();
        ...
        {
            DataTable dataTable = CRUD.Read("SELECT * FROM GRSROT001");
            dataGridView1.DataSource = dataTable;
            dataGridView1.AutoGenerateColumns = true;
            dataGridView1.EditMode = DataGridViewEditMode.EditOnEnter;

            dataGridView1.Columns["COMCODE"].HeaderText = "Firma Kodu";
            dataGridView1.Columns["DOCTYPE"].HeaderText = "Rota Tipi";
            dataGridView1.Columns["DOCTYPETEXT"].HeaderText = "Rota Tipi Açıklaması";
        ...
        private void btnCreate_Click(object sender, EventArgs e)
        {
                ...
                )
            {
                var data = new Dictionary<string, object>
                {
                    ...
                    { "DOCTYPE", txtRotaTipi.Text },
                    { "DOCTYPETEXT", txtRotaTipiAciklamasi.Text },
                    { "ISPASSIVE", ispassive }
                };

                CRUD.Create("GRSROT001", data);
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
                ...
                )
            {
                ...
                string condition = $"COMCODE = '{cbFirma.Text}' AND DOCTYPE = '{txtRotaTipi.Text}'";
                CRUD.Update("GRSROT001", data, condition);
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            {
                string condition = $"COMCODE = '{cbFirma.Text}' AND DOCTYPE = '{txtRotaTipi.Text}'";
                CRUD.Delete("GRSROT001", condition);
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                txtRotaTipi.Text = row.Cells["DOCTYPE"].Value.ToString();
                txtRotaTipiAciklamasi.Text = row.Cells["DOCTYPETEXT"].Value.ToString();
